...
class Crop(nn.Module):
    ...
    def forward(self, noised_and_cover):
        ...
        #     white_filled = noised_image.clone().fill_(1.0)  # assuming image is in [0,1] range
        #     # If your image is in [0,255] range, use fill_(255.0)
            
        #     # Copy the cropped region to the white image
        #     white_filled[:, :, h_start:h_end, w_start:w_end] = noised_image[:, :, h_start:h_end, w_start:w_end]
            
        #     noised_and_cover[0] = white_filled
