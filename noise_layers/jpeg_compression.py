...
class JpegCompression(nn.Module):
    ...
    def apply_conv(self, image, filter_type: str):
        ...
        for channel in range(image.shape[1]):
            ...
            image_yuv_ch = image_yuv_ch.to('cuda:0')
    ...
    def forward(self, noised_and_cover):
        ...
        # Un-pad
        image_ret = image_ret_padded[:, :, :image_ret_padded.shape[2]-pad_height, :image_ret_padded.shape[3]-pad_width].clone()
        result = noised_and_cover.copy()
        result[0] = image_ret
